...
const languageCopy = {
  zh: { navToday: "今日金價", navInternational: "國際金價", navJewelry: "銀樓價格", navRecycle: "黃金回收", navNews: "市場情報", hero: "真金價值，長久相伴。", dashboard: "今日黃金資訊", dashboardText: "報價、走勢、實用工具與市場新聞集中在這裡，點選分頁即可切換。", quotes: "即時報價", history: "歷史金價", tools: "黃金工具", news: "市場新聞", updated: "最後更新", open: "來源時間與延遲請見報價", read: "閱讀完整文章", footer: "資料供投資與消費參考，不構成任何交易建議。" },
  ...
  return (
    <main>
      ...
      <nav className="nav">
        ...
        <div className="navlinks"><a className="active" href="/#quotes">{copy.navToday}</a><a href="/global">全球報價</a><a href="/international">{copy.navInternational}</a><a href="/jewelry">{copy.navJewelry}</a><a href="/recycling">{copy.navRecycle}</a><a href={`/news?lang=${locale}`}>{copy.navNews}</a></div>
